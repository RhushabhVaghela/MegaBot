...
# =====================================================================
# Phase 6B-7: Atomic write tests
# =====================================================================


@pytest.mark.asyncio
async def test_atomic_write_uses_tempfile_and_replace(admin_handler, tmp_path):
    """Verify file_operation 'write' uses tempfile.mkstemp + os.replace (atomic write)."""
...
@pytest.mark.asyncio
async def test_atomic_write_cleans_up_temp_on_failure(admin_handler, tmp_path):
...
@pytest.mark.asyncio
async def test_atomic_write_unlink_oserror_suppressed(admin_handler, tmp_path):
