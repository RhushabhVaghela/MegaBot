...
from megabot.core.task_utils import safe_create_task
...
class MessageRouter:
    ...
    def _to_platform_message(self, message: Message, chat_id: str | None = None) -> Any:
        ...
        from megabot.adapters.messaging import MediaAttachment, MessageType, PlatformMessage
    ...
    async def send_platform_message(
        ...
        Behavior preserved exactly from megabot.core.orchestrator.send_platform_message.
