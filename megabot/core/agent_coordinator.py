...
import megabot.core.agent_file_ops as _file_ops
from megabot.core.agent_file_ops import _audit
from megabot.core.agents import SubAgent
from megabot.core.resource_guard import can_allocate
...
class AgentCoordinator:
    ...
    async def _spawn_sub_agent(self, tool_input: dict) -> str:
        ...
        # the implementation imported from megabot.core.agents.
