...
(``from megabot.core.orchestrator import app, health, ...``) continue to work.
"""
...
from megabot.core.dependencies import (
    register_factory,
    register_service,
    register_singleton,
    resolve_service,
...
from megabot.core.task_utils import (
...
from megabot.adapters.mcp_adapter import MCPManager
...
from megabot.adapters.unified_gateway import UnifiedGateway
from megabot.core import approval_workflows as _approval_workflows
from megabot.core import build_session as _build_session

# Extracted modules
from megabot.core import lifecycle as _lifecycle
from megabot.core import openclaw_handler as _openclaw_handler
from megabot.core import websocket_handler as _ws_handler
from megabot.core.admin_handler import AdminHandler
from megabot.core.agent_coordinator import AgentCoordinator
from megabot.core.config import AdapterConfig, Config

# Shared constants (avoids circular import with websocket_handler)
from megabot.core.constants import GREETING_TEXT  # noqa: F401
